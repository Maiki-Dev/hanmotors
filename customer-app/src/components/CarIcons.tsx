...
import Svg, { Path, Circle, Defs, RadialGradient, Stop, G, Rect } from 'react-native-svg';
...
export const CarIdle = ({ width = 50, height = 50 }: IconProps) => (
  <Svg width={width} height={height} viewBox="0 0 50 50">
    <CarBase />
  </Svg>
);

export const CarMoving = ({ width = 50, height = 50 }: IconProps) => (
  <Svg width={width} height={height} viewBox="0 0 50 50">
    {/* Speed Lines */}
...
export const CarSelected = ({ width = 60, height = 60 }: IconProps) => (
